5182, No pull request found
5161, No pull request found
5154, No pull request found
4240, No pull request found
4131, No pull request found
User Copilot not found. Octokit.NotFoundException: Not Found
   ...
   at Alteridem.GetChanges.GitHubApi.GetUser(String login) in C:\repos\nunit\NUnit.InternalTools\ReleaseNoteTool\GetChanges\GitHubApi.cs:line 114
...
* [5161](https://github.com/nunit/nunit/issues/5161) PlatformAttribute is declared `AllowMultiple = true` but that doesn't work. 
* [4131](https://github.com/nunit/nunit/issues/4131) Platform filter is not inherited. 
...
* [5182](https://github.com/nunit/nunit/issues/5182) Remove unnecessary NUnit analyzer suppressions from latest analyzer package. 
...
* [5154](https://github.com/nunit/nunit/issues/5154) Apply some internal string optimizations. 
...
* [5189](https://github.com/nunit/nunit/issues/5189) Update cake to latest 5.x version. Thanks to [Copilot](https://github.com/Copilot) for [PR 5190](https://github.com/nunit/nunit/pull/5190)
